...
<head>
    ...
    <link rel="stylesheet" href="css/feetable.css">
            ...
            <ul>
              ...
              <li><a href="#Programmes">Programmes</a>
                <ul>
                  ...
                  <li><a href="pg.html" target="">PG</a></li>
                </ul>
              </li>
...
<div>
<h1 style="font-size:40px; background-color:aquamarine;color:white;font-family:arial;text-align:center;">FEE STRUCTURE </h1>
...
for($a=0;$a<count($host);$a++){
  echo "
   <tr>
    <td><a href='fee_display.php?cid=$host1[$a]' target='_blank'>$host[$a]</a></td>
    <td><a href='fee_display.php?cid=$inst1[$a]' target='_blank'>$inst[$a]</a></td>
</tr>";
